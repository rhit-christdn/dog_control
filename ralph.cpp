...
int main(){
    ...
    while (true) {
        ...
        enum CommandType { WALK_FORWARD, RUN_FORWARD, WALK_BACKWARD, RUN_BACKWARD, RUN_DISTANCE, WALK_DISTANCE, STOP, UNKNOWN };
        CommandType cmdType;
        ...
        else if (command == "run_distance")cmdType = RUN_DISTANCE;
        else if (command == "walk_distance")cmdType = WALK_DISTANCE;
